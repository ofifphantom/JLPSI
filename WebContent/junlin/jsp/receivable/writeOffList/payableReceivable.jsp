...
<html lang="en">
	...
	<head>
		...
		<style>
			...
			#supplierBillDiv .searchable-select	{
			z-index:2;
			}
		</style>
	</head>
		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">核销单(应付冲应收)</h4>
		...
		<div id="editDiv" style="display: none;">
			<form class="container">
				...
				<div class="row jl-title">
					...
					<i class="r_f" id="supplierBillDiv">
...
/* 业务员下拉框赋值 */
    	...
    	function getDataJSON(){
     		var companyOne=$("#supplier").val(); 
     		var companyTwo=$("#customer").val();
    		...
    		//应收款单
    		 var  dataJson={"type":6,"companyOne":companyOne,"companyTwo":companyTwo,"money":money,
