...
<html lang="en">
		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">核销单(预付冲应付)</h4>
			...
			<form class="container">
				...
				<div class="jl-panel" id="headEdit">
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-xs-8">
									<select class="form-control" disabled="disabled" id="verificationMethod_add12">
										...
										<option value="1">预付冲应付</option>
										<option value="2">预付冲应付</option>
										<option value="3">应付转应付 </option>
										<option value="4">应付转应付</option>
										<option value="5">应付冲应付</option>
										<option value="6">应付冲应付</option>
										<option value="7">预付转预付</option>
						...
						<div class="col-md-6 col-xs-6">
							<div class="form-group">
								<label for="" class="col-xs-4 control-label intercourseUnit1">预付供应商</label>
						...
						<div class="col-md-6 col-xs-6">
							<div class="form-group">
								...
								<div class="col-xs-8" id="edit_supctoIdDiv">
									<select id="AdvanceIntercourseUnit2" class="form-control">
									</select>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-xs-6">
							<div class="form-group">
								<label for="" class="col-xs-4 control-label">当前预付余额</label>
								<div class="col-xs-8">
									<input type="text" id="balance" class="form-control" value="" disabled="disabled" placeholder="请先选择预付供应商" />
								</div>
							</div>
						</div>
						<div class="col-md-6 col-xs-6">
	...
	laydate.render({
		...
		function prepaidBillAdd() {
			...
			$("#AdvanceIntercourseUnit1").parent().html('<select id="AdvanceIntercourseUnit1" class="form-control"><option value="-1" attr-amountAdvance="">--请选择预付供应商--</option></select>');
			$("#AdvanceIntercourseUnit2").parent().html('<select id="AdvanceIntercourseUnit2" class="form-control"><option value="-1" attr-amountAdvance="">--请选择应付供应商--</option></select>');
    	...
    	function getDataJSON(){
    		...
    		//应付款单
    		 var  dataJson={"type":2,"companyOne":companyOne,"companyTwo":companyTwo,"money":money,
		...
		/*预付供应商/供应商的改变事件 #AdvanceIntercourseUnit1 的值改变事件*/
		...
		function openLayer(layerId, callFun) {
			...
			layer.open({
				...
				yes: function(openLayerIndex) {
					...
					$('#bill').parent().html('<select id="bill"  disabled="disabled"><option value="-1">--请选择应付供应商--</option></select>');
				}
			});
		}
		...
		/*应付供应商/供应商的change事件(类型：1，2) #AdvanceIntercourseUnit2的值改变事件*/
