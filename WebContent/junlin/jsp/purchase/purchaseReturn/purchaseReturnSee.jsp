		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">财务查看采购退货单</h4>
						...
						<table class="table table-striped table-hover col-xs-12" id="datatable">
							...
							<tbody>
								<!-- <tr>
									...
									<td>1</td>
									<td>
										<input type="button" class="btncss edit" onclick="purchaseReturnDetail()" value="详情" />
									</td>
								</tr> -->
							</tbody>
						</table>
							...
							"aoColumns" : [
									...
									},
									{
										...
										"mRender" : function(data, type, row) {
											...
											return '<td><input type="button" class="btncss edit" onclick="purchaseReturnDetail('+data+')" value="详情" /></td>'
