...
<head>
		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">销售订单作废审核</h4>
			...
			<form class="container">
				...
				<div class="row jl-title">
					...
					<b class="r_f" style="margin-top: 13px;">
						<input type="button" class="btncss jl-btn-importent" onclick="goodsAdd()" value="新增" />
					</b>
				...
				<div id="allGoodsDiv">
					<!--<div class="row jl-panel" id="edit_goodDiv">
						<div class="col-xs-6">
							<div class="form-group">
								<label for="edit_goods_name" class="col-xs-4 control-label">货品名称</label>
								<div class="col-xs-8">
							...
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="text" value="" class="form-control" readonly="readonly" placeholder="请先选择商品名称"/>
								</div>
							</div>
	...
	jQuery(function($) {
		...
		function salesOrderDetail(id) {
			...
			$.ajax({
				type: "post",
				url: "<%=basePath%>JLPSI/sales/salesOrder/salesOrderDetail",
				dataType : "json",
				data: {
					"id" : id,
					"type":1
