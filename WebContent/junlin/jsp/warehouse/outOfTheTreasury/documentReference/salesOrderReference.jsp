...
<head>
							...
							<tbody>
								<!-- <tr>
									...
									<td>
										...
										<input type="button" class="btncss edit" onclick="printOutLibraryList()" value="打印生成出库单" />
									</td>
								</tr> -->
							</tbody>
						</table>
	...
	jQuery(function($) {
							...
							"aoColumns" : [
...

									{
										...
										"mRender" : function(data, type, row) {
											...
											+'<input type="button" class="btncss edit" onclick=\'printOutLibraryList(' + JSON.stringify(row) + ')\' value="打印生成备货单" /></td>'
		...
		function printOutLibraryList(row) {
			...
			ajaxJquery("GET","<%=basePath%>sales/salesOrder/createOutboundOrder",{"id":row.id},function(data){
