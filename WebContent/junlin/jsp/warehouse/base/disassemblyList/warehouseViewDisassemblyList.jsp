		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">仓库查看拆卸单</h4>
...
$("#btn_search").click(function() {
	...
	$(function(){
		...
		function orderPrint(row) {
			/*请修改ur地址以及打印次数*/
			ajaxJquery("GET","<%=basePath%>warehouse/packageOrTeardownOrder/printPackageOrTeardownOrder",{"id":row.id,"orderType":2},function(data){
				console.log(data);
