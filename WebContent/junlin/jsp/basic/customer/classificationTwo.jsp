...
<head>
		...
		oTable1 = $('#datatable')
			.dataTable({
				...
				"ajax": {
					...
					"url": "<%=basePath%>basic/classification/getClassificationMsg?type=1&oneOrTwo=2"
				},
	...
	function getDataToOneClassification(){
		...
		function classifitionDel() {
			...
			$.ajax({
				url: '<%=basePath%>basic/classification/decideTwoClassificationIsExits?page=1',
				type: "POST",
				dataType: "json",
				async: false,
				cache: false,
		...
		function classifitionEduce() {
				...
				var export_type=encodeURI(encodeURI(1));
