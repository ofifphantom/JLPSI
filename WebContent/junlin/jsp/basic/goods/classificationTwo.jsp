...
<head>
		...
		oTable1 = $('#datatable')
			.dataTable({
				...
				"ajax": {
					...
					"url": "<%=basePath%>basic/classification/getClassificationMsg?type=3&oneOrTwo=2"
				},
	...
	function getDataToOneClassification(){
		...
		function classifitionDel() {
			...
			$.ajax({
				url: '<%=basePath%>basic/classification/decideTwoClassificationIsExits?page=3',
				type: "POST",
				dataType: "json",
				async: false,
				cache: false,
