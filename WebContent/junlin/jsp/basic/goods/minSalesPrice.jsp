		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">采购填写最低销售价格</h4>
	...
	function getSupctoMsgByCustomerOrSupplier(){
		...
		function getUnit(thispanelid, unit_index_num) {
			var str = `<div class="unit clearfix" id="unit` + unit_index_num + `" attr-id="` + thispanelid + `">
							<div class="col-xs-6 ">
								...
								<div class="form-group">
									<label class="col-xs-4 control-label">基本单位</label>
									<div class="col-xs-8">
										<input type="text" class="form-control base-unit"  value="是" disabled="disabled"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-8">
										<input type="text" class="form-control commonly_price" id="commonly_price "  placeholder="由销售填写" disabled="disabled"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-4 control-label ">最低销售价格</label>
									<div class="col-xs-8">
										<input type="text" class="form-control mini_price" id="mini_price " onkeyup="pressMoney(this)" />
									</div>
								</div>
							</div>
							<div class="col-xs-6 ">
								<div class="form-group">
									...
									<div class="col-xs-8">
										<input type="text" class="form-control mini-purchasing-unit"  value="否" disabled="disabled"/>
									</div>
		...
		function decideInputHasValue(){
			...
			$("#goodstypeDiv .goodsSpecificationDiv").each(function(index, goodsval){
				...
				$(goodsval).find(".unitDiv .unit").each(function(index, val){	
					...
					if($(val).find(".mini_price").val()==null||$(val).find(".mini_price").val()==""){
						inputValue=false;
					}
				});
			});
		...
		function commodityDataToJSON(){
			...
			$("#goodstypeDiv .goodsSpecificationDiv").each(function(index, goodsval){
				...
				//获取商品单位的信息，添加到商品基础的信息里
				$(goodsval).find(".unitDiv .unit").each(function(index, val){	
					var unitDataJSON={"id":$(val).find(".unit_id").val(),"miniPrice":$(val).find(".mini_price").val()};	
