		...
		<div id="Member_Ratings">
			<div class="d_Confirm_Order_style" style="margin-top: 10px;">
				...
				<div class="search-div clearfix">
					<div class="clearfix">
						<span class="l_f"> 分类： <select
							id="searchClassificationOneId"
							onchange="getDataToTwoClassification()"></select> <select
							id="searchClassificationTwoId"></select>
						</span> <span class="l_f"> 名称： <input type="text" value=""
							id="searchName" onblur="cky(this)" />
						</span> <span class="l_f"> 操作人姓名： <input type="text" value=""
							id="searchOperatorName" onblur="cky(this)" />
						</span> <span class="l_f"> 供货商： <select id="searchSupctoId"></select>
				...
				<div class="opration-div clearfix">
					<span class="r_f">
						<button type="button" class="btncss jl-btn-defult"
							onclick="goodsTimes()" style="margin-right: 0;">
				...
				<div class="row jl-panel">
					...
					<div class="row unit">
						...
						<div class="col-xs-6">
							...
							<div class="form-group">
								<label for="specifications" class="col-xs-4 control-label">规格名称：</label>
					...
					<div class="look_unitDivAll">
						...
						<div class="unit-title row"><span>最小订货批量单位信息</span></div>
						<div class="row">
							<div class="unit clearfix check">
								<div class="col-xs-6">
									<div class="form-group">
						...
						<div id="look_inventory_div">
							<div class="unit clearfix" id="look_inventory1">
								<div class="col-xs-6">
									...
									<div class="form-group">
										<label for="mini_inventory " class="col-xs-4 control-label">库存下线：</label>
										<div class="col-xs-8 mini_inventory"></div>
									</div>
									<div class="form-group">
										<label for="max_inventory " class="col-xs-4 control-label">库存上线：</label>
...
<script>
						...
						"mRender": function(data, type, row) {
							if(row.isDelete==1){
								...
								if(row.state==1){
									...
									'<input type="button" class="btncss edit" onclick="goodsDelivery('+data+')" value="送审" /></td>'
								}
								else if(row.state==2){
	...
	function getDataToTwoClassification(){	
		var parentId=$("#searchClassificationOneId").val()-0;
