		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">采购修改总经理审核</h4>
	...
	function getSupctoMsgByCustomerOrSupplier(){
		...
		function goodsTimes(){
			...
			publicMessageLayer("驳回下列所选商品的审核", function() {
				...
				ajaxJquery("POST","<%=basePath%>basic/goods/commodity/operateCommodityState",{"ids":ids2,"operate":15},function(data){
					if(data.success) {
						laysuccess(data.msg);
