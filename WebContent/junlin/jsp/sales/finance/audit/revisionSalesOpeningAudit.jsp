...
<html lang="en">
		...
		<div class="page-content clearfix">
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					<h4 class="text-title">销售开单申请修改审核</h4>
					...
					<div class="opration-div clearfix">
						<span class="r_f"> 
							<button type="button" class="btncss jl-btn-defult" onclick="auditTimes()"><i class="fa fa-times"></i> 驳回</button>
						</span>
						<span class="r_f"> 
							<button type="button" class="btncss jl-btn-defult" onclick="auditCheck()"><i class="fa fa-check"></i> 通过</button>
						</span>
	...
	function auditTimes() {
		...
		publicMessageLayer("驳回所选销售开单的修改审核", function() {
			$.ajax({
	...
	function auditCheck() {
		...
		publicMessageLayer("通过所选销售开单的修改审核", function() {
			$.ajax({
				url :'<%=basePath%>sales/salesOrder/updateStateByIds',
				type: "POST",
				dataType: "json",
