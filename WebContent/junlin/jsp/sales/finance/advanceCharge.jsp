...
<html lang="en">
			...
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					...
					<div class="opration-div clearfix">
						<span class="r_f"> 
							<button type="button" class="btncss jl-btn-defult" onclick="advanceCharge()"><i class="fa fa-paypal"></i> 确认收款</button>
						</span>
	...
	function advanceCharge() {
		...
		MessageLayer("该操作无法恢复，请确认无误后点击确定。", function() {
			$.ajax({
