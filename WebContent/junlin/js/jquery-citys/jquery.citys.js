...
;(function (factory) {
    ...
    $.fn.citys = function(parameter,getApi) {
        ...
        var defaults = {
            //dataUrl:'http://117.158.178.202:8001/JLPSI/junlin/js/jquery-citys/list.json',     //数据库地址
        	dataUrl:'http://localhost:8080/JLPSI/junlin/js/jquery-citys/list.json',     //数据库地址
