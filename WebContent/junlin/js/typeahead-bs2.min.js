...
!function($) {
	...
	Typeahead.prototype = {
		...
		hide : function() {
			this.$menu.hide()
			this.shown = false
			if($("#edit_commodity_name")&&$("#edit_commodity_name").parents().is("#goodsManagerPage")){
				$("#goodsManagerPage #edit_commodity_name").attr("onblur","searchCommodityMsgByName()");
				searchCommodityMsgByName();
			}	
			return this
		}
