...
public interface SalesOrderService extends BaseService<SalesOrder> {
	 ...
	 * 
	 */
	public DataTables getSalesOrderMsg(DataTables dataTables, String identifier, String supctoName,

			String commodityName, Integer isSpecimen, Integer page,String  date,Integer type,String name,String phone,String orderer,Integer isAppOrder,String createTime,int state,
