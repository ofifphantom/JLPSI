 ...
 * 采购计划单/采购订单mapper
 * @author 柳亚婷
 * @date  2018年4月18日  上午10:19:57
 * @Description 
 *
 */
public interface ProcureTableMapper extends BaseMapper<ProcureTable>{
	 ...
	 * @return
	 */
	public List<ProcureTable> selectBatchByPrimaryKey(Map<String, Object> map);
	 ...
	 * @return
	 */
	public boolean deleteBatchByPrimaryKey(Map<String, Object> map);
